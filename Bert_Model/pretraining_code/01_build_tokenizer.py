...
paths = [str(x) for x in glob("data/train/*.txt")]
...
tokenizer.save(tokenizer_save_dir+"/tokenizer.json")
# tokenizer.save_vocabulary(tokenizer_save_dir+"/vocab.txt")
...
# del tokenizer_args["vocab_file"]
# tok2 = BertTokenizer.from_pretrained(TOK.out)
# print()
# print("RELOADED")
# print(tok2)
